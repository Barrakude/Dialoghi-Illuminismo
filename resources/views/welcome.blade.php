        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="container mt-5 mb-5 box">
                    <div class="row">
                        <div class="col-md-6 image-container">
                            <img class="p-3" src="{{ asset('https://www.radiofrance.fr/s3/cruiser-production/2022/06/b3af3dd2-1ca9-409d-b36f-fa1cced3c79e/1200x680_sans-titre-16.jpg') }}" alt="Esempio di Immagine"
                                class="image-frame">
                        </div>
                        <div class="col-md-6 my-5 image-description">
                ...
                <div class="container mt-5 mb-5 box">
                    <div class="row">
                        <div class="col-md-6 image-container">
                            <img src="{{asset('https://cdn.radiofrance.fr/s3/cruiser-production/2020/08/bad5614c-e147-4738-a181-4be0e0927abb/1136_054_cor20719.jpg')}}" alt="Esempio di Immagine"
                                class="p-3 image-frame">
                        </div>
                        <div class="col-md-6 my-5 image-description">
                            <h2>La Questione Femminile</h2>
                            <p>Il periodo che precede la Rivoluzione è fortemente caratterizzato dalla presenza di élites femminili in quasi tutti gli stati europei. Benché a fatica, poche donne riescono ad accedere all’istruzione, più spesso da autodidatte, e a riflettere sulla loro condizione sociale. Esse propongono riforme legislative a favore del genere femminile, degli oppressi, degli schiavi.</p>
